 ...
 * this function. 
 * *********************************************************/
int HoneywellPressureSpi::spiOpen(std::string devspi){
    int statusVal = -1;
...
int HoneywellPressureSpi::spiClose(){
    int statusVal = -1;
 ...
 * "data". 
 * ******************************************************************/
int HoneywellPressureSpi::spiWriteRead( unsigned char *data, int length){
...
HoneywellPressureSpi::HoneywellPressureSpi(){
 ...
 * ***********************************************/
HoneywellPressureSpi::HoneywellPressureSpi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord){
    this->mode = spiMode ; 
