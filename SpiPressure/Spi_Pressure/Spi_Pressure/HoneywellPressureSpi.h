 ...
 * ****************************************************************************/
#ifndef HONEYWELLPRESSURESPI_H
    #define HONEYWELLPRESSURESPI_H
#include <unistd.h>
#include <stdint.h>
#include <fcntl.h>
#include <sys/ioctl.h>
...
class HoneywellPressureSpi{
 
public:
    HoneywellPressureSpi();
    HoneywellPressureSpi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord);
    ~HoneywellPressureSpi();
